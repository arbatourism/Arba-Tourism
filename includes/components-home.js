// Header HTML Template for Home Page (with special scroll behavior)
const headerHTML = `<header id="home-header">
    <nav class="navbar">
        ...
        <ul class="nav-menu">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    <div class="submenu">
                        <a href="top-abu-dhabi-tours.html" class="submenu-trigger">Abu Dhabi <span class="arrow-right">›</span></a>
                        <div class="submenu-content">
                    ...
                    <div class="submenu">
                        <a href="top-dubai-tours.html" class="submenu-trigger">Dubai <span class="arrow-right">›</span></a>
                        <div class="submenu-content">
